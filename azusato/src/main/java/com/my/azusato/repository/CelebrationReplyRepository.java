...
public interface CelebrationReplyRepository extends JpaRepository<CelebrationReplyEntity, Long> {
   ...
   * @return お祝い書き込み
   */
  public Optional<CelebrationReplyEntity> findByNoAndCommonFlagDeleteFlag(Long celebraionReplyNo,
      boolean deleted);


  /**
   * where celebrationNo = "celebrationNo";
   * 
   * @param celebrationNo お祝い番号
   * @return お祝い書き込みリスト
   */
  public List<CelebrationReplyEntity> findByCelebrationNo(Long celebrationNo);
}
