...
public class ProfileEntityTest extends AbstractIntegration{
	...
	class Update{
		...
		public void normal_case() throws Exception {
			...
			.commonDate(CommonDateEntity.builder()
					.createDatetime(TestConstant.Entity.createdDatetime)
					.updateDatetime(updatedDatetimeForTest)
					.build())
			...
			savedData.getCommonDate().setUpdateDatetime(updatedDatetimeForTest);
